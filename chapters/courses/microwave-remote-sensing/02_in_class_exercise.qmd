...
aoi = subset.isel(time=4, x=slice(0, 500), y=slice(0, 500))
aoi_lin = 10 ** (aoi / 10)
...
sig0_monthly_sample = sig0_monthly.isel(x=slice(0, 500), y=slice(0, 500))
```
...
db_array = sig0_monthly_sample.sel(time="2022-07-30", method="nearest")
