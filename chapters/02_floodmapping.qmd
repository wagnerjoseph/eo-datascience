...
:::{note}
This notebooks contains interactive element. The full interactive element can only be viewed on Binder by clicking on the Binder badge or 🚀 button.
:::
...
pointer = hv.streams.PointerXY(source=mrs_view.get(1), x=100, y=100)
